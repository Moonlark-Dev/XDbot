...
img_admin = nonebot.on_command("img", permission=nonebot.permission.SUPERUSER)
...
notice = nonebot.on_command(
    "broadcast", aliases={"notice"}, permission=nonebot.permission.SUPERUSER)
ping = nonebot.on_command("ping")
status = nonebot.on_command("status")
screenshot = nonebot.on_command(
    "screenshot", permission=nonebot.permission.SUPERUSER)
